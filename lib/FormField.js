...
var _ErrorDecorator = require('./ErrorDecorator');

var _ErrorDecorator2 = _interopRequireDefault(_ErrorDecorator);
    ...
    _createClass(FormField, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                _ErrorDecorator2.default,
                { error: error, touched: touched },
                _react2.default.createElement(_reactBootstrap.Input, _extends({}, newProps, { bsStyle: bsStyle, hasFeedback: touched }))
            );
        }
    }]);
